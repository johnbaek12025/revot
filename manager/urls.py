...
urlpatterns = [
    ...
    path('check/review/ticket/', LoggedIn([2], True)(TicketManage.as_view(http_method_names=['get', 'post'])), name='review-ticket'),
    path('check/purchase/ticket/', LoggedIn([2], True)(TicketManage.as_view(http_method_names=['get', 'post'])), name='purchase-ticket'),
